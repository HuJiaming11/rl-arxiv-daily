<p align="center">
  <h1 align="center"><br><ins>RL-ARXIV-DAILY</ins><br>Automatically Update RL Papers Daily using Github Actions</h1>
...
This repository hosts the source code for rl-arxiv-daily, an useful sripts to fetch arxiv paper daily. 
...
1. Fork this [repo](https://github.com/HuJiaming11/rl-arxiv-daily)
2. Edit configs:
...
4. Setting Gitpages (optional)
    ...
    - Now you can open gitpage: https://your_github_usrname.github.io/rl-arxiv-daily
    # Modified by HuJiaming11: Updated gitpage URL from cv-arxiv-daily to rl-arxiv-daily
